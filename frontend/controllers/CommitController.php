...
class CommitController extends Controller
{
    ...
    /**
     * Displays a single Commit model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing Commit model.
    ...
    /**
     * Deletes an existing Commit model.
    ...
    /**
     * Finds the Commit model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Commit the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
